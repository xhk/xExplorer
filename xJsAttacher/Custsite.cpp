												  ...
												  LRESULT * plResult)
{
	...
	MessageBox(hwnd, (CString)lpstrText, L"Custom Browser", /*dwType*/MB_ICONERROR);
				...
				IDispatch* pDispatchObjectHit)
{
	METHOD_PROLOGUE(CCustomControlSite, DocHostUIHandler)
		...
		//return __super::ShowContextMenu(dwID, pptPosition, pCommandTarget, pDispatchObjectHit);
}
